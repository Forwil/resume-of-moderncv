...
\section{实习与项目经历}
\cventry{2016.3--至今}{见习研究员}{SenseTime 商汤科技}{北京研发中心}{智能视频组}
...
\cvitem{深度学习}{熟悉物体检测、属性、识别等常见计算机视觉算法，熟悉各类深度学习模型inference框架，包括Caffe、cudnn、TensorRT等}
...
{负责批改作业、讲授习题课}
\cventry{2016.9—2017.1}{助教}{北航计算机学院编译原理}{本科课}{}
{负责批改作业、小测验、实验课习题课讲解}
\cventry{2016.9—2017.1}{助教}{北航计算机学院形式语言与自动机}{研究生课}{}
{负责批改作业，习题课讲解}
...
\cvitem{2016}{专利：基于目标特征点和产生式循环网络的多目标跟踪方法（在投）}
\end{document}
