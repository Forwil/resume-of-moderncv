...
\section{实习与项目经历}
\cventry{2016.3--至今}{见习研究员}{SenseTime 商汤科技}{北京研发中心}{智能视频组（Mentor:闫俊杰）}
...
{编写、维护视频人脸检测跟踪识别系统SenseFace-GPU/CPU-SDK，视频结构化系统SenseVideo-GPU-SDK，负责模型升级、并行优化加速、多平台移植和交付。把监控算法移植到了各种嵌入式平台并优化性能达到产品水平，包括Nvidia tegra x1/x2、Hisi3519、Movidius芯片。在MOT16（Multiple Object Tracking）上，使用行人检测和re-id特征优化了Tracking算法，取得包括MOTA（68.2和66.1）在内的多项指标世界第一。
}
